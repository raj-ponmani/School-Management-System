...
def session():
    return [
        (session_year.id, str(session_year.session_start_year)+" to "+str(session_year.session_end_year)) for session_year in SessionYearModel.objects.all()
    ]
...
class AddStudentForm(forms.Form):
    ...
    course_id = forms.ChoiceField(label="Course", choices=courses, widget=forms.Select(attrs={"class":"form-control"}))
    gender = forms.ChoiceField(label="Gender", choices=gender_list, widget=forms.Select(attrs={"class":"form-control"}))
    session_year_id = forms.ChoiceField(label="Session Year", choices=session, widget=forms.Select(attrs={"class":"form-control"}))
